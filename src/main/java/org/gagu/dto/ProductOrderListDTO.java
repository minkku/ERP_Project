...
public class ProductOrderListDTO {
    ...
    private Timestamp productOrderModifiedDate; // 수정일
    ...
    public ProductOrderListDTO(String productOrderNumber, Timestamp productOrderOrderdate, Timestamp productOrderModifiedDate,
                               String businessvenderName, String productName,
                               Integer productOrderItemQuantity, Integer productOrderPriceAmount,
                               Integer productOrderStatus, Integer productOrderId) {
        this.productOrderNumber = productOrderNumber;
        this.productOrderOrderdate = productOrderOrderdate;
        this.productOrderModifiedDate = productOrderModifiedDate;
